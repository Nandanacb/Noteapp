...
class _NotePageState extends State<NotePage>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      body: GridView.builder(gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,crossAxisSpacing: 10,mainAxisSpacing: 10), 
            ...
            child: Column(
              ...
              children: [
               ...
               TextField(
                ...
                decoration: InputDecoration(border: OutlineInputBorder(),hintText: 'category'),),
                 SizedBox(height: 20,),
                TextField(
